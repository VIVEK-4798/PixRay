...
const isActiveStyle = 'flex items-center px-5 font-extrabold gap-3 border-r-2 border-black transition-all duration-200 ease-in-out capitalize'
    ...
    <div className='flex flex-col justify-between bg-white overflow-y-scroll min-w-210 hide-scrollbar'>
        <div className='flex flex-col'>
            ...
            <div className='flex flex-col gap-5'>
                ...
                <h3 className='mt-2 text-base px-5 2xl:text-xl'>Discover Categories</h3>
        ...
        {user && (
            <Link 
              to={`user-profile/${userInfo.googleId}`} 
              className='fixed bottom-0 flex my-5 mb-3 gap-2 p-2 items-center bg-white rounded-lg shadow-lg mx-3'
              onClick={handleCloseSidebar}
              >
